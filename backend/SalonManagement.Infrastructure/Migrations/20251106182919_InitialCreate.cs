        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specializations = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalonManagers_Salons_SalonId",
                        column: x => x.SalonId,
                        principalTable: "Salons",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_SalonId_IsActive",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalonManagers_Email",
                table: "SalonManagers",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SalonManagers_SalonId",
                table: "SalonManagers",
                column: "SalonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalonWorkingHours_SalonId_DayOfWeek",
